...
| Дизайн | **Премиальный минимализм**, светлая + тёмная тема, акцент — фиолетовый |
...
Дизайн: палитра и компоненты из `premium.html` (Inter + Newsreader, акцент `#6e56cf`,
светлая/тёмная темы, мягкие границы, минимум теней).
